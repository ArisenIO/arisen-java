...
public class NegativeTransactionProcessorTest {
    ...
    public void prepare_thenFailWithGetInfoError() throws TransactionPrepareError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ArisenError>instanceOf(GetInfoRpcError.class));
    ...
    public void prepare_thenFailWithGetBlockError() throws TransactionPrepareError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ArisenError>instanceOf(GetBlockRpcError.class));
    ...
    public void signCallSerialize_thenFailWithGetAbiError() throws TransactionSignError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ArisenError>instanceOf(TransactionCreateSignatureRequestError.class));
        ...
        // Mock ABI provider
        try {
            when(this.mockedABIProvider.getAbi(any(String.class), any(ARISENName.class))).thenThrow(new GetAbiError());
    ...
    public void signCallCreateSignature_thenFailWithGetAvailableKeyError() throws TransactionSignError {
        exceptionRule.expect(TransactionSignError.class);
        exceptionRule.expectMessage(ErrorConstants.TRANSACTION_PROCESSOR_SIGN_CREATE_SIGN_REQUEST_ERROR);
        exceptionRule.expectCause(IsInstanceOf.<ArisenError>instanceOf(TransactionCreateSignatureRequestKeyError.class));
        ...
        // Mock AbiProvider
        this.mockGetAbi(ARISENTOKENABIJSON);
    ...
    public void signCallGetSignature_thenFailWithEmptySerializedTransactionError()
        ...
        exceptionRule.expectCause(IsInstanceOf.<ArisenError>instanceOf(
        ...
        this.mockSignTransaction(Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN)
                .fromJson(mockedEmptyTransactionSignatureResponseJSON, ArisenTransactionSignatureResponse.class));
    ...
    public void signCallGetSignature_thenFailWithEmptySignatureError()
        ...
        this.mockSignTransaction(Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN)
                .fromJson(mockedEmptySignaturesSignatureResponseJSON, ArisenTransactionSignatureResponse.class));
    ...
    public void signCallGetSignatureWithTransactionModified_thenFailWithDeserializeTransactionError()
        ...
        this.mockGetAvailableKey(Arrays.asList("Key1", "Key2"));
        this.mockSignTransaction(Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN)
                .fromJson(mockedArisenTransactionSignatureResponseModifiedTransactionJSON, ArisenTransactionSignatureResponse.class));
    ...
    public void broadCast_thenFailWithPushTransactionError() throws TransactionBroadCastError {
        ...
        exceptionRule.expectCause(IsInstanceOf.<ArisenError>instanceOf(TransactionPushTransactionError.class));
        ...
        this.mockGetAvailableKey(Arrays.asList("Key1", "Key2"));
        this.mockSignTransaction(Utils.getGson(DateFormatter.BACKEND_DATE_PATTERN)
                .fromJson(mockedArisenTransactionSignatureResponseJSON, ArisenTransactionSignatureResponse.class));
    ...
    private void mockSignTransaction(ArisenTransactionSignatureResponse mockedResponse) {
        try {
            when(this.mockedSignatureProvider.signTransaction(any(ArisenTransactionSignatureRequest.class))).thenReturn(mockedResponse);
    ...
    private void mockGetAbi(String abiJSON) {
        try {
            when(this.mockedABIProvider.getAbi(any(String.class), any(ARISENName.class))).thenReturn(abiJSON);
        } catch (GetAbiError getAbiError) {
            getAbiError.printStackTrace();
            fail("Exception should not be thrown here for mocking getAbi");
        }
        ...
        try {
            doAnswer(new Answer() {
                ...
                public Object answer(InvocationOnMock invocationOnMock) {
                    ...
                    ((AbiRixSerializationObject) args[0]).setHex(mockedActionHex);
                    return null;
                }
            }).when(this.mockedSerializationProvider).serialize(any(AbiRixSerializationObject.class));
