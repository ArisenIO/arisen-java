...
public class PEMProcessorTest {
    ...
    */
    ...
    public void validatePublicKeyExtractionFromPrivateKey(){
        ...
        try {
            PEMProcessor pemProcessor1 = new PEMProcessor(RIXFormatter.convertRIXPrivateKeyToPEMFormat(privateKey1));
            assertEquals(publicKey1, pemProcessor1.extractRIXPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor2 = new PEMProcessor(RIXFormatter.convertRIXPrivateKeyToPEMFormat(privateKey2));
            assertEquals(publicKey2, pemProcessor2.extractRIXPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor3 = new PEMProcessor(RIXFormatter.convertRIXPrivateKeyToPEMFormat(privateKey3));
            assertEquals(publicKey3, pemProcessor3.extractRIXPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor4 = new PEMProcessor(RIXFormatter.convertRIXPrivateKeyToPEMFormat(privateKey4));
            assertEquals(publicKey4, pemProcessor4.extractRIXPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor5 = new PEMProcessor(RIXFormatter.convertRIXPrivateKeyToPEMFormat(privateKey5));
            assertEquals(publicKey5, pemProcessor5.extractRIXPublicKeyFromPrivateKey(false));
            PEMProcessor pemProcessor6 = new PEMProcessor(RIXFormatter.convertRIXPrivateKeyToPEMFormat(privateKey6));
            assertEquals(publicKey6, pemProcessor6.extractRIXPublicKeyFromPrivateKey(false));
