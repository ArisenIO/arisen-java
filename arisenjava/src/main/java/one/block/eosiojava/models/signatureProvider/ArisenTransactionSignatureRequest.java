 ...
 * need to be signed.
 */
public class ArisenTransactionSignatureRequest {
    ...
    /**
     * The arisen public keys which will be used to find the private keys (or key identities) to sign
     ...
     * arisenTransactionSignatureResponse#getSerializeTransaction()} and this field is false then
     * {@link one.block.arisenjava.error.session.TransactionGetSignatureNotAllowModifyTransactionError}
     * will be thrown.
     */
    private boolean isModifiable;

    /**
     * Instantiates a new arisen transaction signature request.
     *
     ...
     * transaction
     */
    public ArisenTransactionSignatureRequest(String serializedTransaction,
     ...
     * <br>
     * The arisen public key that will be used to find the private keys (or key identities) to sign
     * the serialized transaction.
     *
     ...
     * <br>
     * If the signature provider modifies the serialized transaction and returns it in the response {@link
     * arisenTransactionSignatureResponse#getSerializeTransaction()} but this field is false then
     * {@link one.block.arisenjava.error.session.TransactionGetSignatureNotAllowModifyTransactionError}
     * will be thrown.
     *
     * @return the boolean
