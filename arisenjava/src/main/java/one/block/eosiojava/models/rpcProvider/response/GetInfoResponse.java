...
public class GetInfoResponse {
     ...
     * call:  {@link one.block.arisenjava.utilities.RixFormatter#prepareSerializedTransactionForSigning(String,
     * String)}
     */
     ...
     * one.block.arisenjava.interfaces.IRPCProvider#getBlock(GetBlockRequest)} at {@link
     * one.block.arisenjava.session.TransactionProcessor#prepare(List)}
     */
     ...
     * Transaction#setExpiration(String)}} at {@link one.block.arisenjava.session.TransactionProcessor#prepare(List)}
     */
     ...
     * one.block.arisenjava.utilities.RixFormatter#prepareSerializedTransactionForSigning(String,
     * String)}
     *
     * @return the chain id.
     */
