...
/**
 * The response of getBlock() RPC call {@link one.block.arisenjava.interfaces.IRPCProvider#getBlock(GetBlockRequest)}
 */
public class GetBlockResponse {
     ...
     * {@link one.block.arisenjava.models.rpcProvider.Transaction}.
     */
