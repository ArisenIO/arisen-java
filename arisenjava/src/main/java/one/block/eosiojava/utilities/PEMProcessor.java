...
public class PEMProcessor {
    ...
    /**
     * Extract RIX public key
     *
     * @param isLegacy - Set to true if the legacy format of the key is desired.  This uses "RIX"
     ...
     * @return RIX format public key of the current private key
     * @throws PEMProcessorError when the public key extraction fails.
     */
    public String extractRIXPublicKeyFromPrivateKey(boolean isLegacy) throws PEMProcessorError {
        ...
        try {
            return RIXFormatter.encodePublicKey(publicKeyByteArray, keyCurve, isLegacy);
     ...
     *
     * @param isLegacy Whether to return the legacy format of the key.  This uses "RIX"
     * to prefix the key data and only applies to keys generated with the secp256k1 algorithm.  The
     * new format prefixes the key data with "PUB_K1_".
     * @return RIX format public key of the current private key
