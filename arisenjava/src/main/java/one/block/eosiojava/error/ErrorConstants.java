...
public class ErrorConstants {
    ...
    //RIXFormatter() Errors
    /**
     * The private key provided is not in the RIX format.
     */
    public static final String INVALID_RIX_PRIVATE_KEY = "The RIX private key provided is invalid!";
    /**
     * The public key provided is not in the RIX format.
     */
    public static final String INVALID_RIX_PUBLIC_KEY = "The RIX public key provided is invalid!";
    /**
     * An error occurred while Base58 decoding the RIX key.
     */
    public static final String BASE58_DECODING_ERROR = "An error occurred while Base58 decoding the RIX key!";
    /**
    ...
    /**
     * Error message get thrown if {@link IABIProvider#getAbi(String, ARISENName)} get error.
     */
    ...
    /**
     * Error message get thrown if Action's serialization process get error by calling {@link ISerializationProvider#serialize(AbiRIXSerializationObject)}
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(ArisenTransactionSignatureRequest)} returns error
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(ArisenTransactionSignatureRequest)} return empty serialized transaction.
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(ArisenTransactionSignatureRequest)} return no signature.
     */
    ...
    /**
     * Error message get thrown if {@link ArisenTransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(ArisenTransactionSignatureRequest)} has modified serialized transaction but {@link TransactionProcessor#isTransactionModificationAllowed()} is false
     */
    ...
    /**
     * Error message get thrown if {@link ISerializationProvider#deserializeTransaction} returns error during deserialize modified serialized transaction inside {@link ArisenTransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(ArisenTransactionSignatureRequest)}
     */
    ...
    /**
     * Error message get thrown if {@link ISignatureProvider#signTransaction(ArisenTransactionSignatureRequest)} return error during process of {@link TransactionProcessor#sign()}
     */
    ...
    /**
     * Error message get thrown if {@link ISerializationProvider#deserializeTransaction} returns empty result during deserialize modified serialized transaction inside {@link ArisenTransactionSignatureResponse} which return from {@link ISignatureProvider#signTransaction(ArisenTransactionSignatureRequest)}
     */
